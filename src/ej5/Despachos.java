...
// creamos la clase "Despachos" para customizar el método que obtiene los registros de la tabla "despachos"
public class Despachos {

	// el método que obtiene registros de la tabla "despachos"
